...
/*un objeto es un objeto de variables que abstraen unae entidad fisica o conceptual de la que es significativo almacenar informarción 
para el programa o sistema que estemos desarrollando.

Para acceder a las propieddades individuales basta con poner el nombre del objeto un "." y el nombre de la propiedad*/

console.warn("3. Lectutura de Propiedad de un objeto");

console.log(`la propiedad: ${property1.name}($${property1.id})descrita como: ${property1.description} se encuenta actualmente a la 
${property1.isSaleable?", venta": property1.isRentable?", renta": " no disponible"} por un precio de: $${property1.price}
 con los servicios incluidos de: ${property1.includedServices}.`);
...
/* Para modificar los datos de una variable basta con acceder a la propiedad deseada a modifica 
y asignarle su nuevo a través del signo = */
